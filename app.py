...
def predict():
	...
	if request.method == 'POST':
		...
		article.download()
		article.parse()
		title = spacy_cleaner(article.title)
		text = spacy_cleaner(article.text)
		...
		my_prediction = [round(gb.predict_proba([text+" "+title])[0][0] * 100, 2), round(gb.predict_proba([text+" "+title])[0][1] * 100, 2)]
